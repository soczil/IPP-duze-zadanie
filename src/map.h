...
/** @brief Usuwa z mapy drogę krajową.
 * Usuwa z mapy drogę krajową o podanym numerze, jeśli taka istnieje.
 * @param[in,out] map    – wskaźnik na strukturę przechowującą mapę dróg;
 * @param[in] routeId    – numer drogi krajowej.
 * @return Wartość @p true, jeśli droga krajowa została usunięta.
 * Wartość @p false, jeśli z powodu błędu nie można usunąć tej drogi krajowej:
 * podany numer jest niepoprawny, droga krajowa o podanym numerze nie istnieje.
 */
